...
func (x *AnalyzingResponse) Reset() {
	*x = AnalyzingResponse{}
	mi := &file_grpc_ModuleBalancing_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyzingResponse) Descriptor() ([]byte, []int) {
	return file_grpc_ModuleBalancing_proto_rawDescGZIP(), []int{19}
}
...
func (x *ExpirationPushRequest) Reset() {
	*x = ExpirationPushRequest{}
	mi := &file_grpc_ModuleBalancing_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExpirationPushRequest) Descriptor() ([]byte, []int) {
	return file_grpc_ModuleBalancing_proto_rawDescGZIP(), []int{20}
}
...
func (x *ExpirationPushResponse) Reset() {
	*x = ExpirationPushResponse{}
	mi := &file_grpc_ModuleBalancing_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExpirationPushResponse) Descriptor() ([]byte, []int) {
	return file_grpc_ModuleBalancing_proto_rawDescGZIP(), []int{21}
}
...
const file_grpc_ModuleBalancing_proto_rawDesc = "" +
	...
	"modulename\x12\x1c\n" +
	"\theartbeat\x18\x03 \x01(\tR\theartbeat2\xab\x04\n" +
	"\x06Module\x12K\n" +
	...
	"\fAllowStorage\x12$.ModuleBalancing.AllowStorageRequest\x1a%.ModuleBalancing.AllowStorageResponse2q\n" +
...
var file_grpc_ModuleBalancing_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_grpc_ModuleBalancing_proto_goTypes = []any{
	...
	(*EmptyRequest)(nil),                  // 4: ModuleBalancing.EmptyRequest
	(*MD5Request)(nil),                    // 5: ModuleBalancing.MD5Request
	(*MD5Response)(nil),                   // 6: ModuleBalancing.MD5Response
	(*DataRequest)(nil),                   // 7: ModuleBalancing.DataRequest
	(*DataResponse)(nil),                  // 8: ModuleBalancing.DataResponse
	(*StorerecordRequest)(nil),            // 9: ModuleBalancing.StorerecordRequest
	(*StorerecordResponse)(nil),           // 10: ModuleBalancing.StorerecordResponse
	(*IntegrityVerificationRequest)(nil),  // 11: ModuleBalancing.IntegrityVerificationRequest
	(*IntegrityVerificationResponse)(nil), // 12: ModuleBalancing.IntegrityVerificationResponse
	(*ModuleDownloadRequest)(nil),         // 13: ModuleBalancing.ModuleDownloadRequest
	(*ModulePushResponse)(nil),            // 14: ModuleBalancing.ModulePushResponse
	(*UploadRequest)(nil),                 // 15: ModuleBalancing.UploadRequest
	(*Finformation)(nil),                  // 16: ModuleBalancing.finformation
	(*UploadResponse)(nil),                // 17: ModuleBalancing.UploadResponse
	(*AnalyzingRequest)(nil),              // 18: ModuleBalancing.analyzingRequest
	(*AnalyzingResponse)(nil),             // 19: ModuleBalancing.analyzingResponse
	(*ExpirationPushRequest)(nil),         // 20: ModuleBalancing.ExpirationPushRequest
	(*ExpirationPushResponse)(nil),        // 21: ModuleBalancing.ExpirationPushResponse
}
var file_grpc_ModuleBalancing_proto_depIdxs = []int32{
	16, // 0: ModuleBalancing.UploadRequest.information:type_name -> ModuleBalancing.finformation
	15, // 1: ModuleBalancing.Module.Upload:input_type -> ModuleBalancing.UploadRequest
	18, // 2: ModuleBalancing.Module.Analyzing:input_type -> ModuleBalancing.analyzingRequest
	11, // 3: ModuleBalancing.Module.IntegrityVerification:input_type -> ModuleBalancing.IntegrityVerificationRequest
	13, // 4: ModuleBalancing.Module.Push:input_type -> ModuleBalancing.ModuleDownloadRequest
	2,  // 5: ModuleBalancing.Module.ModuleReload:input_type -> ModuleBalancing.ModuleReloadRequest
	0,  // 6: ModuleBalancing.Module.AllowStorage:input_type -> ModuleBalancing.AllowStorageRequest
	20, // 7: ModuleBalancing.Expirationpush.Expiration:input_type -> ModuleBalancing.ExpirationPushRequest
	9,  // 8: ModuleBalancing.Storerecord.Updatestorerecord:input_type -> ModuleBalancing.StorerecordRequest
	5,  // 9: ModuleBalancing.ClientCheck.MD5:input_type -> ModuleBalancing.MD5Request
	7,  // 10: ModuleBalancing.ClientCheck.Data:input_type -> ModuleBalancing.DataRequest
	17, // 11: ModuleBalancing.Module.Upload:output_type -> ModuleBalancing.UploadResponse
	19, // 12: ModuleBalancing.Module.Analyzing:output_type -> ModuleBalancing.analyzingResponse
	12, // 13: ModuleBalancing.Module.IntegrityVerification:output_type -> ModuleBalancing.IntegrityVerificationResponse
	14, // 14: ModuleBalancing.Module.Push:output_type -> ModuleBalancing.ModulePushResponse
	3,  // 15: ModuleBalancing.Module.ModuleReload:output_type -> ModuleBalancing.EmptyResponse
	1,  // 16: ModuleBalancing.Module.AllowStorage:output_type -> ModuleBalancing.AllowStorageResponse
	21, // 17: ModuleBalancing.Expirationpush.Expiration:output_type -> ModuleBalancing.ExpirationPushResponse
	10, // 18: ModuleBalancing.Storerecord.Updatestorerecord:output_type -> ModuleBalancing.StorerecordResponse
	6,  // 19: ModuleBalancing.ClientCheck.MD5:output_type -> ModuleBalancing.MD5Response
	8,  // 20: ModuleBalancing.ClientCheck.Data:output_type -> ModuleBalancing.DataResponse
...
func file_grpc_ModuleBalancing_proto_init() {
	...
	file_grpc_ModuleBalancing_proto_msgTypes[15].OneofWrappers = []any{
